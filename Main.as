package  {
	...
	public class Main extends MovieClip {
		...
		// ------ TODO: грузить фото, использовать внешний класс для загрузки текстов, разобраться с фокусом текстов, удалять объекты, менять точки регистрации, панель функций, zoom ------
